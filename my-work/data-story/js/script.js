...
d3.json("salingData.json").then(function(salesData){
  d3.csv("StockX-statistics.csv").then(function(incomingData){
    d3.json("us-states.json").then(function(geoData){
      ...
      salesData = salesData.slice(0,4000);
...
// visualization
  ...
  function sneakerBefore(){
    let sneakerBefore1 =sneakerBefore.append("g")
        .attr("class","aj1")
        .translate(w/3,h/3)
      ;
    sneakerBefore1.html(aj1);

    let sneakerBefore2 = sneakerBefore.append("g")
        .attr("class","aj11")
    ...
    let purchases = salingChart.selectAll(".purchases")
          ...
          ;
            enterView({
              ...
              exit: function(el) {
                // el.classList.remove('entered');
                purchases.select(".purchases").transition()
                  .duration(1000)
                  .attr("cx",function(d){
                    return xScale(d.releaseDate)
                  })
...
//SVG
let airmax90 = `<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
 width="905.000000pt" height="495.000000pt" viewBox="0 0 905.000000 495.000000"
...
let airmax97 = `<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
 width="1247.000000pt" height="609.000000pt" viewBox="0 0 1247.000000 609.000000"
 preserveAspectRatio="xMidYMid meet">
  <metadata>
  Created by potrace 1.16, written by Peter Selinger 2001-2019
  </metadata>
...
let aj1 = `<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" xml:space="preserve">
...
`;
let yeezy = `<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
 width="400.000000pt" height="260.000000pt" viewBox="0 0 400.000000 260.000000"
 preserveAspectRatio="xMidYMid meet">
<metadata>
Created by potrace 1.16, written by Peter Selinger 2001-2019
</metadata>
